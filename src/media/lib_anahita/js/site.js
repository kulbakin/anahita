//\media\lib_anahita\js\site.src.js
...
(function () {
    ...
    Class.refactor(Form.Validator, {
        validate: function (event) {
            ...
            //if all validations passed and there are remote validators pending
            if (result  && remoteValidators.isPending() && event) {
                event.preventDefault();
    ...
    Form.Validator.add('validate-password', {
        ...
        test: function (element, props) {
            /**
             * XXX
             * Temporaly disabled due to:
             *  - min length is configurable parameter
             *  - anahita currently does not apply such strict rules
             */
            return true;
            ...
            if (sections.url) {
                ...
                ['header','footer','body'].each(function (section) {
                    ...
                    if (content) {
                        ...
                        // if header doesn't have a close then add it
