<?php
/**
 * Abstract Class. Provides assign, __set and __get and assign.
 * All the views support assigning data
 * 
 * @category   Anahita
 * @package    Lib_Base
 * @subpackage View
...
abstract class LibBaseViewAbstract extends KObject
{
    ...
    public function getRoute($route = '', $fqr = true)
    {
        ...
        if( ! isset($parts['view'])) {
            ...
            //since the view is missing then get the data from the state
