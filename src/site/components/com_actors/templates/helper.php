        ...
        switch (strtolower($type)) {
            case 'pronoune':
                if ($options['useyou']) {
                    ...
                    $value  = $gender == 'male'  ? 'LIB-AN-HE' : ($gender == 'female'  ? 'LIB-AN-SHE' : 'LIB-AN-THEY');
                }
                break;
            case 'possessive': 
                if ($options['useyou']) {
                    ...
                    $value  = $gender == 'male' ? 'LIB-AN-HIS' : ($gender == 'female' ? 'LIB-AN-HER' : 'LIB-AN-THEIR');
                }
                break;
            case 'objective': 
                if ($options['useyou']) {
                    ...
                    $value  = $gender == 'male' ? 'LIB-AN-HIM' : ($gender == 'female' ? 'LIB-AN-HER' : 'LIB-AN-THEM');
                }
                break;
        }
