...
<div class="an-socialgraph-stat">
    ...
    <?php if ($viewer->eql($actor) && $actor->isLeadable() && $actor->isFollowable() && $actor->mutualCount): ?>
        <div class="stat-count">
            <?= $actor->mutualCount ?>
    ...
    <?php if ( ! $viewer->eql($actor) && $actor->isLeadable() && $viewer->isLeadable()): ?>
        <?php $commons = $actor->getCommonLeaders($viewer); ?>
        <?php if (isset($commons) && $commons->getTotal()): ?>
            <div class="stat-count">
                <?= $commons->getTotal() ?>
...
<?php if ($actor->leaderCount + $actor->followerCount): ?>
    <div class="an-gadget-socialgraph">
        ...
        <?php if ( ! $viewer->eql($actor) && isset($commons) && $commons->getTotal()): ?>
