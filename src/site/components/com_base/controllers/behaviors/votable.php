...
class ComBaseControllerBehaviorVotable extends KControllerBehaviorAbstract 
{
     ...
     * @return string
     */
    protected function _actionGetvoters(KCommandContext $context)
    {
        $this->commit();
     ...
     * @return void
     */
    protected function _actionVote(KCommandContext $context)
    {
     ...
     * @return void
     */
    protected function _actionUnvote(KCommandContext $context)
    {
