    ...
    public function __construct($subject, $config = array())
    {
        ...
        if (in_array('suhosin', get_loaded_extensions())) {
            ...
            if ( ! @ini_get('suhosin.executor.include.whitelist') || strpos(@ini_get('suhosin.executor.include.whitelist'), 'tmpl://') === false) {
                JError::raiseWarning(0, JText::sprintf('Your server has Suhosin loaded. Please follow <a href="%s" target="_blank">this</a> tutorial.', 'https://nooku.assembla.com/wiki/show/nooku-framework/Known_Issues'));
                return;
            }
        }
