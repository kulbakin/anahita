...
<img border=&quot;1&quot; src=&quot;<?php echo $img_path; ?>&quot; name=&quot;imagelib&quot; alt=&quot;<?php echo JText::_( 'No preview available' ); ?>&quot; width=&quot;206&quot; height=&quot;145&quot; />"><a href="<?php echo JURI::base(true) ?>/index.php?option=com_templates&amp;task=edit&amp;cid[]=<?php echo $row->directory;?>&amp;client=<?php echo $client->id;?>">
    ...
    public static function editTemplateSource($template, &$content, $option, &$client, &$ftp)
    {
        JRequest::setVar( 'hidemainmenu', 1 );
    ...
    public static function chooseCSSFiles($template, $t_dir, $t_files, $option, &$client)
    {
        JRequest::setVar( 'hidemainmenu', 1 );
        ?>
        <form action="index.php" method="post" name="adminForm">
     ...
     * @param string The option
     */
    public static function editCSSSource($template, $filename, &$content, $option, &$client, &$ftp)
    {
        JRequest::setVar('hidemainmenu', 1);
