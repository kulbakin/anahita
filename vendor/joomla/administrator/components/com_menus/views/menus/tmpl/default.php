...
<form action="index.php" method="post" name="adminForm">
    ...
    <?php foreach ($this->menus as $menu) : ?>
        <?php
            ...
            $link  = JURI::base(true).'/index.php?option=com_menus&amp;task=editMenu&amp;id='. $menu->id;
            $linkA = JURI::base(true).'/index.php?option=com_menus&amp;task=view&amp;menutype='. htmlspecialchars($menu->menutype);
        ?>
        <tr class="<?php echo "row". $k; ?>">
            ...
            <span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit Menu Name' );?>::<?php echo htmlspecialchars($menu->title); ?>">
                <a href="<?php echo $link ?>"><?php echo htmlspecialchars($menu->title) ?></a></span>
            </td>
            <td>
